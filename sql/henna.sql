...
INSERT INTO `henna` (`symbol_id`, `symbol_name`, `dye_id`, `dye_amount`, `price`, `stat_INT`, `stat_STR`, `stat_CON`, `stat_MEM`, `stat_DEX`, `stat_WIT`)
VALUES (1, 'symbol_s+1c-3_d', 4445, 10, 5100, '0', '1', '-3', '0', '0', '0'),
