...
INSERT INTO `weapon` (`item_id`, `name`, `bodypart`, `crystallizable`, `weight`, `soulshots`, `spiritshots`, `material`, `crystal_type`, `p_dam`, `rnd_dam`, `weaponType`, `critical`, `hit_modify`, `avoid_modify`, `shield_def`, `shield_def_rate`, `atk_speed`, `mp_consume`, `m_dam`, `durability`, `price`, `crystal_count`, `sellable`)
VALUES
	(1, 'Short Sword', 'rhand', 'false', 1600, 1, 1, 'steel', 'none', 8, 10, 'sword', 8, 0.00000, 0, 0, 0, 379, 0, 6, 95, 768, 0, 'true'),
